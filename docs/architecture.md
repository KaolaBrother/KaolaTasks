...
@kaola/forge-adapters   createForgeAdapter (validateToken + getPullRequest + importIssue + registerWebhook +
                        parseWebhook + commentOnIssue are adapter methods; parseIssueUrl and
